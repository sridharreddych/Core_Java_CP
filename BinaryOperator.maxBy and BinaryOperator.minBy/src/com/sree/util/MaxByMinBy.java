...
/**
 * @author Sridhar reddy BinaryOperator.maxBy and BinaryOperator.minBy
 *         BinaryOperator.maxBy accepts a Compotator and returns BinaryOperator
 *         which will return maximum between two elements. In the same way,
